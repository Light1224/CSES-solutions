...
inline void solve() {
    ...
    // ----------------------------------
    // Count intervals containing each i
    // ----------------------------------

    for (int i = 0; i < N; i++) {
        int r = a[i][1];

        int pos = lower_bound(rights.begin(),
                              rights.end(),
                              r) - rights.begin() + 1;
        ...
        // having right >= r
        int total = i;
        int smaller = query(pos - 1);

        contained[a[i][2]] = total - smaller;
    ...
    // ----------------------------------
    // Count intervals each i contains
    // ----------------------------------
